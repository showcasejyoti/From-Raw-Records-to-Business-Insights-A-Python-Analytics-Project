...
I personally collected two months of real-world business data from a local fiber welding repair shop and built a complete analytics workflow—from data collection and cleaning to exploratory data analysis (EDA) and visualization.
...
## 🔨 Business Problem
The shop owner maintained daily transaction records but lacked a structured way to analyze business performance. As a result, important questions such as the following could not be answered easily:
...
## 📂 Datasets Used
The project uses **four EXCEL files**:
- `dim_date.xlxs` – Date-related information  
- `dim_customer.xlxs` – Customer details  
- `fact_transaction.xlxs` –Transactional data  
- `fact_expense.xlxs` – Daily business expenses  
...
---
## 🔗 Connect With Me
- **LinkedIn:** _Add your LinkedIn post or profile link here_  
